<?php
/** サンプルプログラム : nlp_ai/training_code/code-4-3-2-e.php
  * [説明]
  * 「4.3.2.文書のグループに登場する単語の頻度を求めよう：20 News Groupsコーパス編」の内容を扱うサンプルプログラム。
  * Corpus_20NewsGroups と Morpheme クラスを使い、文書間における単語の出現頻度を計算する。
  * 
