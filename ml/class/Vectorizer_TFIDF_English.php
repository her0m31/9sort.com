<?php
/** サンプルプログラム : nlp_ai/training_code/class/Vectorizer_TFIDF_English.php
  * [説明]
  * TF-IDFベクトルを生成するクラス。
  * 英語の文書に形態素解析に対応する。
  * 
...
class Vectorizer_TFIDF_English
{
    /** 
      * @var    array       各単語の出現文書数
      */
    ...
    /** 英語の文書を指定し、各単語の出現文書数、総文書数を追加する。
      * @param          string          text            英語の文書
    ...
    function importDocument( $text )
    {
        ...
        /* 形態素解析結果を取得する */
        $morphemeResult     = $this->m->parseEnglish( $text );
